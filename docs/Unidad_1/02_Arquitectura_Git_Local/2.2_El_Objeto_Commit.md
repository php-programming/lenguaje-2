...
```mermaid
graph TD
    subgraph Objetos_en_BD["Objetos en la Base de Datos de Git (.git/objects)"]
        Commit_A["Commit fa3a1b2"]
        Tree_A["Tree d8329fc"]
        Blob_Readme["Blob a54b2f1\n# Hola Mundo"]
        Blob_Gitignore["Blob 1a9f3b7\nnode_modules/"]

        Commit_A -->|tree| Tree_A
        Tree_A -->|"README.md"| Blob_Readme
        Tree_A -->|".gitignore"| Blob_Gitignore
        Commit_A -->|parent| Commit_Parent["Commit padre (...)"]
    end
