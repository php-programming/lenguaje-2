...
graph TD
    subgraph RepoLocal
        A[Rama main]
        B[Rama feature/get-user]
        C[Commit 1: logica endpoint]
        D[Commit 2: pruebas unitarias]
        E[Push de la rama a GitHub]
    end
    ...
    subgraph PlataformaGitHub
        F[Rama feature/get-user en GitHub]
        G[Pull Request]
        H[Revision de codigo]
        I[Verificaciones de CI]
        K[Codigo integrado en main]
    end
    ...
    subgraph RepoLocalIter
        J[Nuevos commits basados en feedback]
    end
